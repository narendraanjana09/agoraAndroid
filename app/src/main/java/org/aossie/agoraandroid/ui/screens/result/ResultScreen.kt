  ...
  Scaffold(
    ...
    Box(modifier = Modifier
      ...
      Column(
        ...
        if (progressErrorState.error.second) {
          PrimarySnackBar(
            text = progressErrorState.error.first,
          ) {
          }
        }
        if (progressErrorState.errorResource.second) {
          PrimarySnackBar(
            text = stringResource(id = progressErrorState.errorResource.first),
          ) {
          }
        }
        if (progressErrorState.isLoading.second) {
          PrimaryProgressView(
            text = progressErrorState.isLoading.first,
          )
        }
